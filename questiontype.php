...
class qtype_trees extends question_type {
    ...
    public function extra_question_fields() {
        return array('qtype_trees_options', 'q_type', 'preorder', 'inorder', 'postorder', 'bstvalues', 
                            'bst_string', 'avlvalues', 'avl_string', 'lecturer_tree', 'requested_properties', "properties_string");
    }
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        // AVL
        $question->avlvalues = $questiondata->options->avlvalues;
        $question->avl_string = $questiondata->options->avl_string;
