...
class qtype_avl_edit_form extends question_edit_form {
    ...
    {
        $mform->addElement("header","build_tree","Generate AVL Tree With Specified nodes");
        $mform->addElement('html', file_get_contents(new moodle_url('type/avl/Widgets/LectuerWidget.html')));
    }
    ...
    {
        $mform->addElement("header","build_tree","Generate AVL Tree With Specified nodes");
        $widget=file_get_contents(new moodle_url('type/avl/Widgets/LectuerWidget.html'));

        $mform->addElement('html',$widget);
       // $mform->disabledIf('build_tree',"question_category",'neq',"Construct");
    }
