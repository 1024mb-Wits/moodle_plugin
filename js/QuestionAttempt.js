class QuestionAttempt {
    ...
    configureHTML() {
        console.log("QTYPE: ", this.main.databaseMisc.qtype);
        switch(this.main.databaseMisc.qtype) {
            ...
            case this.main.qTypes.BST:
                console.log("EXECTUED ", this.main.databaseMisc.qtype);
                this.bstAttempt = new BSTAttempt(this, this.main, this.answerBox);
                this.bstAttempt.configureHTML(); 
                break;
            case this.main.qTypes.AVL:
                this.avlAttempt = new AVLAttempt(this, this.main, this.answerBox);
                this.avlAttempt.configureHTML(); 
                break;
    ...
    treeToString() {
        ...
        else if(this.main.databaseMisc.qtype === this.main.qTypes.AVL) {
            this.avlAttempt.treeToString();
        }
        else {
    ...
    reconstructLastAnswer() {
        if(this.main.databaseMisc.qtype === this.main.qTypes.TRAVERSAL) {
            ...
            this.avlAttempt.reconstructLastAnswer();
        }
