class BSTQuestion {
    constructor(main) {
        ...
        //This holds the actual string of the tree for the give nodes->hidden element as not actually displyed
        //Used to mark
        this.bstString = document.getElementById("bst_string");
        //This is the actual values of the nodes to constrict tree->displayed to student and on lec side in thr box
    ...
    updateQuestionType() {
        ...
        //if checked random values then jump to update the random vals 
