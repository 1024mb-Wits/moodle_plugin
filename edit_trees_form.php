...
class qtype_trees_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $mform->addElement('header', 'new_widg_test', "Test New Widget");
        $mform->addElement('html', file_get_contents(new moodle_url('/question/type/trees/Nodes/Trees_test_1_1_1.html')));
        ...
        $mform->addElement('hidden', 'avlvalues','', array('id'=>'avlvalues'));
        $mform->addElement('hidden', 'avl_string','', array('id'=>'avl_string'));
    ...
    public function setupBSTControls($mform) {
        $mform->addElement('radio', 'question_type', '', "Construct AVL Tree", 1, array('qtype_name'=>'bst'));
    ...
    public function setupAVLControls($mform)
    {
        $mform->addElement('radio', 'question_type', '', "Construct BST", 4, array('qtype_name'=>'avl'));
        $mform->addElement('text', 'node_amount_avl', "Number of Nodes", array('value'=>10));
        $mform->hideIf('node_amount_avl', 'question_type', 'neq', 4);
    }
